    ...
    <form action= "prosesForm.php" method= "POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input name="jenis_kelamin" id="jenis_kelamin_2" type="radio" required="required" class="custom-control-input" value="Pokemon"> 
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <select id="prodi" name="prodi" class="custom-select" required="required">
                    ...
                    <option value="Bisnis Gelap">Bisnis Gelap</option>
                </select>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-8">
                <select id="domisili" name="domisili" class="custom-select" required="required">
                    ...
                    <option value="Rumah Edu">Rumah Edu</option>
                </select>
            </div>
        </div>
        <div class="form-group row">
